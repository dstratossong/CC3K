...
public:
    ...
    const static int BASE_MISS_CHANCE = 50;

    Vampire(Map* map, MapCell* parent, int pos_x, int pos_y)
    : Character(map, parent, pos_x, pos_y, SYMBOL_VAMPIRE, BASE_HIT_POINT, BASE_ATTACK_POINT, BASE_DEFENCE_POINT, BASE_MISS_CHANCE, "Vampire")
    {};
    ~Vampire() {};
